...
@section('title', 'Category UMKM')
@section('page-title', 'Category UMKM')
...
@section('content')
    ...
    <!-- Page Header -->
    <div class="mb-6">
        <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Category MSME</h1>
        <p class="text-gray-600 mt-2">Kelola kategori untuk pelaku UMKM</p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-xl shadow-lg p-5 text-white">
            <div class="flex justify-between items-center">
                <div>
                    <p class="text-sm font-medium opacity-90 uppercase tracking-wider">Terisi UMKM</p>
                    <p class="text-3xl font-bold mt-2">{{ $stats['with_umkm'] ?? 0 }}</p>
                </div>
                <div class="bg-white bg-opacity-20 p-3 rounded-full">
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="px-6 py-4 border-b flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
                <h2 class="text-xl font-semibold text-gray-800">Daftar Kategori UMKM</h2>
            ...
            <div class="flex flex-col md:flex-row gap-3 w-full md:w-auto">
                <!-- Search -->
                <form method="GET" action="{{ route('admin.category-umkm.index') }}" class="flex">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full 
                                    {{ $category->total_umkm > 0 ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
                                    {{ $category->total_umkm }} UMKM
                                </span>
                            </td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex space-x-2">
                                    <a href="{{ route('admin.category-umkm.show', $category) }}" 
                                    ...
                                    @else
                                    <span class="text-gray-400 p-2" title="Tidak dapat dihapus karena memiliki UMKM">
                                        <i class="fas fa-trash"></i>
                                    </span>
                                    @endif
                                </div>
