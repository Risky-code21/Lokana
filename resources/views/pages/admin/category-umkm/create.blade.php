...
@section('page-title', 'Tambah Kategori UMKM')
...
@section('content')
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow p-6">
            <!-- Header -->
            <div class="mb-6">
                <h2 class="text-xl font-bold text-gray-800">Tambah Kategori UMKM Baru</h2>
                <p class="text-gray-600 mt-1">Isi form di bawah untuk menambahkan kategori baru</p>
            </div>
            
            <!-- Form -->
            <form action="{{ route('admin.category-umkm.store') }}" method="POST">
                @csrf
