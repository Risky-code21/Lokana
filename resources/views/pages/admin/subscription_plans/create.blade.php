...
@section('content')
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow p-6">
            <!-- Header -->
            <div class="mb-6">
                <h2 class="text-xl font-bold text-gray-800">Tambah Paket Langganan Baru</h2>
                <p class="text-gray-600 mt-1">Isi form di bawah untuk menambahkan paket langganan baru</p>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        @error('features')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-xs text-gray-500 mt-1">Tambahkan fitur-fitur yang termasuk dalam paket</p>
                    </div>
