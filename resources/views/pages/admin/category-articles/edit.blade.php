...
@section('content')
    ...
    <div class="max-w-2xl mx-auto">
        <div class="bg-white rounded-lg shadow p-6">
            <!-- Header -->
            <div class="mb-6">
                <h2 class="text-xl font-bold text-gray-800">Edit Kategori Artikel</h2>
                <p class="text-gray-600 mt-1">Ubah informasi kategori artikel</p>
            </div>
            
            <!-- Form -->
            <form action="{{ route('admin.article-categories.update', $category_article) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="name" 
                               id="name"
                               value="{{ old('name', $category_article->name) }}"
                    ...
                    <div>
                        ...
                        <textarea name="description" 
                                  ...
                                  required>{{ old('description', $category_article->description) }}</textarea>
                        @error('description')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
